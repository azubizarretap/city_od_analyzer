...
SELECT	DISTINCT E.Nombre As Nombre ,UE.Latitud As Latitud,UE.Longitud As Longitud,D.Nombre As Distrito, 'Evento' As Tipo
FROM
...
UNION
SELECT	DISTINCT T.Equipamiento As Nombre ,F.Latitud As Latitud,F.Longitud As Longitud,D.Nombre As Distrito, AT.Nombre As Tipo
FROM
	COA.F_PARADA F,
	COA.D_TRANSPORTE T,
