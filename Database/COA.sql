...
CREATE OR REPLACE VIEW COA.V_TEST_TRANSPORTE_EVENTOS AS
...
UNION
SELECT	DISTINCT T.Equipamiento As Nombre ,F.Latitud As Latitud,F.Longitud As Longitud, AT.Nombre As Tipo
FROM
	COA.F_PARADA F,
	COA.D_TRANSPORTE T,
